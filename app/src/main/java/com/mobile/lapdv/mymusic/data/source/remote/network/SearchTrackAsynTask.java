    ...
    public List<Track> parseSongObject(String data) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                song.setArtworkUrl(objectSong.getString(Track.TrackEntity.ARTWORK_URL));
                ...
                song.setUri(objectSong.getString(Track.TrackEntity.URI));
                ...
                song.setAvatarUrl(jsonObjectUser.getString(Track.TrackEntity.AVATAR_URL));
                songList.add(song);
            }
